...
@include('notification.notify')
	...
	<a class="add-btn my-3" href="#" type="button"  data-bs-toggle="modal" data-bs-target="#addfacility">ADD NEW FACILITY</a>
		...
		<table class="table  table-bordered" id="myTable">
			...
			<tbody>
				...
				<tr>
					...
					@endif</td>
					<td class="btn-bg1"><a type="button" id="{{$facility->id}}" class="table-edit fw-bold" data-bs-toggle="modal" data-bs-target="#editfacility">Edit</a> </td>
										...
										<div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 ps-4 ">
											<div class="profile-img-holder add-event-img-holder  mb-3">
												...
												<div id="add-facility-img-preview-modal1"  class="image-preview">
													...
													<input type="file" name="image1" id="add-facility-img-upload-modal1" />
												</div>
												<div id="add-facility-img-preview-modal2"  class="image-preview">
													...
													<input type="file" name="image2" id="add-facility-img-upload-modal2" />
												</div>
												<div id="add-facility-img-preview-modal3"  class="image-preview">
													...
													<input type="file" name="image3" id="add-facility-img-upload-modal3" />
												</div>
											</div>
											<h2>Tenant</h2>
										...
										<div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 ps-4 ">
											<div class="profile-img-holder add-event-img-holder  mb-3">
												...
												<div id="edit-facility-img-preview-modal1"  class="image-preview">
													...
													<input type="file" name="image1" id="edit-facility-img-upload-modal1" />
												...
												<div id="edit-facility-img-preview-modal2"  class="image-preview">
													...
													<input type="file" name="image2" id="edit-facility-img-upload-modal2" />
												...
												<div id="edit-facility-img-preview-modal3"  class="image-preview">
													...
													<input type="file" name="image3" id="edit-facility-img-upload-modal3" />
        ...
        // $('.table-edit').click(function(e) {
            ...
            $.ajax({
                ...
                success : function(response) {
        			...
        			//console.log(response.avlb_days);
		            //avlb_day_
