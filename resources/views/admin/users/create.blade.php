                            ...
                            <div class="form-row">
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                           name="name" value="{{ old('name') }}" placeholder="@lang('Name')"/>
                                    @error('name')
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <select
                                        ...
                                        @foreach($workInstructions as $workInstruction)
                                            <option
                                                value="{{ $workInstruction->id }}">{{ $workInstruction->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('work_instruction')
                                    @include('developer::partials.error_field')
                                    @enderror
                                </div>
                                <div class="form-group col-4">
                                    ...
                                    <input type="number" class="form-control @error('frequency') is-invalid @enderror"
                                           name="frequency" value="{{ old('frequency') }}"
