		...
		<table class="table  table-bordered" id="myTable">
			<thead>
				<tr>
					...
					<th scope="col"><span>Google Map</span></th>
			...
			<tbody>
				...
				<tr>
					<td><a href="{{route('admin.hotel_view',$hotel->id)}}">{{$hotel->name}}</a></td>
					<td>{{$hotel->date}}</td>
					<td>{{$hotel->location}}</td>
					<td>@if($hotel->status==1)
						Publish
					...
					<td class="cursor-pointer fw-bold table-edit" id="{{$hotel->id}}" data-bs-toggle="modal" data-bs-target="#editUser">Edit</td>
					<td class="btn-bg2"><a  type="button" class="table-delete fw-bold" data-bs-toggle="modal" data-bs-target="#remove-item"  data-hotelid="{{$hotel->id}}">Delete</a></td>
				</tr>
				@endforeach
					...
					<div class="row">
						<div class="col-12">
							<div class="body-wrapper">
								...
								<form method="post" action="{{route('admin.addHotel')}}" enctype="multipart/form-data">
                 					{{csrf_field()}}
										...
										<div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4  ">
											<div class="add-family-form-wrapper ps-2 pe-3">
												...
												<div class="location-indicator">
													...
													<input class="pe-4 location" type="text" name="location" required="required">
										...
										<div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 ps-4 label-size">
											<div class="profile-img-holder add-event-img-holder  mb-3">
												...
												<div id="add-hotel-img-preview-modal2"  class="image-preview">
													...
													<div class="delete-image d-none" style="cursor: pointer;"><span>x</span></div>
													<input type="file" class="hotel-image"  name="image2" id="add-hotel-img-upload-modal2" />
												</div>
												<div id="add-hotel-img-preview-modal3"  class="image-preview">
													...
													<div class="delete-image d-none" style="cursor: pointer;"><span>x</span></div>
													<input type="file" class="hotel-image"  name="image3" id="add-hotel-img-upload-modal3" />
												</div>
											</div>
											<h2>Tenant</h2>
											<div class="profile-tenant-form">
												...
												<div class="form-check form-check-inline mb-2">
													<input class="form-check-input" name="tenant_type[]" type="checkbox" id="inlineCheckbox3" value="Non-Tenant">
												...
												<div class="property-input-wrapper">
													...
													<div class="form-check form-check-inline property_radio">
														<input class="form-check-input property_radio" name="property[]" type="checkbox" id="property" value="{{$property->id}}">
 					...
 					<div class="row">
 						<div class="col-12">
 							<div class="body-wrapper">
 								...
 								<button type="button" class="btn-close-modal float-sm-end float-start mt-0 me-sm-0 me-4" data-bs-dismiss="modal" aria-label="Close"><i class="far fa-times-circle" aria-hidden="true"></i></button>
 								<form method="post" action="{{route('admin.addHotel')}}" enctype="multipart/form-data" id="editform">
                 					{{csrf_field()}}
 										...
 										<div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 ps-4 label-size">
 											<div class="profile-img-holder add-event-img-holder  mb-3">
 												...
 												<div id="edit-hotel-img-preview-modal2"  class="image-preview">
 													...
 													<div class="delete-image d-none" style="cursor: pointer;"><span>x</span></div>
													<input type="file" name="image2" id="edit-hotel-img-upload-modal2" />
													<input type="hidden" class="edit-hotel-image" name="image_2" id="image2">
 												...
 												<div id="edit-hotel-img-preview-modal3"  class="image-preview">
 													...
 													<div class="delete-image d-none" style="cursor: pointer;"><span>x</span></div>
													<input type="file" name="image3" id="edit-hotel-img-upload-modal3" />
													<input type="hidden" class="edit-hotel-image" name="image_3" id="image3">
 											...
 											<div class="profile-tenant-form">
 												<div class="form-check form-check-inline">
 													<input class="form-check-input tenantcheck" type="checkbox" id="elite" name="tenant_type[]" value="Elite" >
 													<label class="form-check-label" for="inlineCheckbox1">Elite</label>
 												</div>

 												<div class="form-check form-check-inline">
 													<input class="form-check-input tenantcheck" name="tenant_type[]" type="checkbox" id="regular" value="Regular">
 													<label class="form-check-label" for="inlineCheckbox2">Regular</label>
 												</div>

 												<div class="form-check form-check-inline mb-2">
 													<input class="form-check-input tenantcheck" name="tenant_type[]" type="checkbox" id="nontenant" value="Non-Tenant">
 													<label class="form-check-label" for="inlineCheckbox3">Non-Tenant</label>
 												</div>
 												<!--<div class="form-check form-check-inline mb-2">
...
<div class="modal remove-item" id="remove-item" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content bg-transparent border-0">
      <form method="POST" action="{{ route('admin.deleteHotel','hotel') }}">
      {{method_field('delete')}}
      {{csrf_field()}}
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        // $('.table-edit').click(function(e) {
            e.preventDefault(); // prevent form from reloading page
          	...
          	$("#edit-hotel-img-preview-modal2").css("background-image", "unset");
          	$("#edit-hotel-img-preview-modal3").css("background-image", "unset");
			$('.edit-hotel-image').prev().removeClass('d-flex justify-content-end');
			$('.edit-hotel-image').prev().addClass('d-none');
            var id=$(this).attr('id');


            $.ajax({
                url  : "{{route('admin.getHotel')}}",
                type : 'Post',
                ...
                success : function(response) {
        			...
        			for(var i=0; i<=3; i++){
        				...
        				if(i<response.images.length){
        					...
        					var img=i+1;
        					$("#edit-hotel-img-preview-modal"+img+"").css("background-image", "url(" + response.images[i].path + ")");
	        				$("#image"+img).val(response.images[i].id);
							$("#edit-hotel-img-upload-modal"+img+"").prev().removeClass('d-none');
                            $("#edit-hotel-img-upload-modal"+img+"").prev().addClass('d-flex justify-content-end');
        				}else{
        					var img=i+1;
        					$("#edit-hotel-img-preview-modal"+img+"").css("background-image", "unset");
	        				$("#image"+img).val(0);
        				}
        			}
                },
    ...
    $('#remove-item').on('show.bs.modal', function (event) {
        ...
        modal.find('.modal-body #hotelid').val(hotelid);
    })
...
<script type="text/javascript">
    ...
    $.uploadPreview({
      input_field: "#add-hotel-img-upload-modal2",
      preview_box: "#add-hotel-img-preview-modal2",
      label_field: "#add-hotel-img-label-modal2"
    });

    $.uploadPreview({
      input_field: "#add-hotel-img-upload-modal3",
      preview_box: "#add-hotel-img-preview-modal3",
      label_field: "#add-hotel-img-label-modal3"
    });
	$('.hotel-image').on('change', function(){
    ...
    $.uploadPreview({
      input_field: "#edit-hotel-img-upload-modal2",
      preview_box: "#edit-hotel-img-preview-modal2",
      label_field: "#edit-hotel-img-label-modal2"
    });

    $.uploadPreview({
      input_field: "#edit-hotel-img-upload-modal3",
      preview_box: "#edit-hotel-img-preview-modal3",
      label_field: "#edit-hotel-img-label-modal3"
    });
	$('.edit-hotel-image').on('change', function(){
    	$delete_image = $(this).prev();
    	$delete_image.removeClass('d-none');
    	$delete_image.addClass('d-flex justify-content-end');
    });
	...
	$( "#addnewhotel form" ).submit(function( event ) {
			var form=0;
			...
			if($(this).find('#add-hotel-img-upload-modal1').val() || $(this).find('#add-hotel-img-upload-modal2').val() ||$(this).find('#add-hotel-img-upload-modal3').val()){
				form++;
			}else{
