            ...
            return window.File && window.FileList && window.FileReader ? void(void 0 !== e(i.input_field) && null !== e(i.input_field) && e(i.input_field).change(function() {
                ...
                if (l.length > 0) {
                    ...
                    o.addEventListener("load", function(l) {
                        var o = l.target;
						console.log(a.type);
                        a.type.match("image") ? (e(i.preview_box).css("background-image", "url(" + o.result + ")"), e(i.preview_box).css("background-size", "100% 100%"), e(i.preview_box).css("background-repeat", "no-repeat")) : a.type.match("audio") ? e(i.preview_box).html("<audio controls><source src='" + o.result + "' type='" + a.type + "' />Your browser does not support the audio element.</audio>") :a.type.match("pdf")?(e(i.preview_box).css("background-image", "url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRVpLdNnCEtTc83vk2jkzs1H47PqiQfBxn74Q&usqp=CAU)"), e(i.preview_box).css("background-size", "100% 100%"), e(i.preview_box).css("background-repeat", "no-repeat")): alert("This file type is not supported yet.")
